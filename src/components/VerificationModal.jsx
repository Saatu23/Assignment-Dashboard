        ...
        {step === 1 ? (
          <div>
            ...
            <div className="mt-4 flex justify-end space-x-2">
              ...
              <button onClick={() => setStep(2)} className="px-3 py-1 bg-blue-600 text-white rounded">Yes, I have submitted</button>
            </div>
          </div>
        ) : (
          <div>
            ...
            <div className="mt-4 flex justify-end space-x-2">
              <button onClick={() => setStep(1)} className="px-3 py-1 border rounded">Go Back</button>
              <button onClick={confirm} className="px-3 py-1 bg-green-600 text-white rounded">Confirm Submission</button>
            </div>
          </div>
        )}
      </div>
